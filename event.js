...
class Event {
    ...
    //  ###                                                               #
    /**
     * Returns a rated player from their Discord user ID or name.
     * @param {string} userId The Discord user ID or name.
    ...
    static async getRatedPlayer(userId) {
        ...
        return ratedPlayers.find((p) => p.DiscordID === userId || p.Name === userId);
    }
